...
const QueryGenerator = {
  ...
  _templateCache: {},
  _cachedTemplate(tplStr) {
      let tpl = this._templateCache[tplStr];
      if (!tpl) {
          tpl = _.template(tplStr, this._templateSettings);
          this._templateCache[tplStr] = tpl;
      }
      return tpl;
  },
  ...
  */
  insertQuery(table, valueHash, modelAttributes, options) {
    ...
    if (this._dialect.supports.returnValues && options.returning) {
      if (this._dialect.supports.returnValues.returning) {
        ...
        if (modelAttributes && options.hasTrigger && this._dialect.supports.tmpTableTrigger) {
          ...
          tmpTable = this._cachedTemplate(tmpTable)(replacement).trim();
    ...
    return this._cachedTemplate(query)(replacements);
  },
  ...
  */
  updateQuery(tableName, attrValueHash, where, options, attributes) {
    ...
    return this._cachedTemplate(query)(replacements).trim();
  },
